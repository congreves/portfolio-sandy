    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div class="flex flex-wrap items-center justify-between">
            ...
            <ul class="flex items-center space-x-3 md:order-3">
                <li>
                    <a href="#" title="" class="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-7 h-7 focus:bg-[#73BA9B] hover:bg-[#73BA9B] hover:border-[#73BA9B] focus:border-[#73BA9B]">
            ...
            <p class="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2022, All Rights Reserved by Sandy Congreve</p>
        </div>
    </div>
</section>

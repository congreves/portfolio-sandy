          ...
          <ul class="flex items-center space-x-3 md:order-3">
            <li>
              <a
                href="#"
                title=""
                class="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-7 h-7 focus:bg-[#73BA9B] hover:bg-[#73BA9B] hover:border-[#73BA9B] focus:border-[#73BA9B]"
              >
                <svg
                  class="w-4 h-4"

      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2 p-4">
          ...
          <p className="py-4">
            ...
            revolving UX, branding and strategy. Since I have a passion for
            people and design I choose to develop my role in UX/UI. During my
            studies I started working as a UI designer at Svea Solar designing
            mock-ups for their site. At Svea I worked closely with frontend
            engineers, gained knowledge of building resuable components and the
            weight of consistency cross design and code. This inspired me to
            continue my studies as a Frontend Developer which I now studied for
            a bit over 1 year. I identified myself being of being a designer
            turning developer so with that said I&#39;m a react and CSS nerd. I
            can&#39;t shut up about utility-first driven CSS and consistency in
            development.
          </p>
          ...
          <p className="py-4">
            <span className="text-[#73BA9B]">➸</span> Being able to grow and
            experimenting with cutting-edge CSS and JS.
            <br />
            <span className="text-[#73BA9B]">➸</span> Develop my skills working
            methodically in projects with a team and more experienced
            developers.
            <br />
            <span className="text-[#73BA9B]">➸</span> I wish to be in an
            enviorment where I can learn but also make mistakes to learn from.
